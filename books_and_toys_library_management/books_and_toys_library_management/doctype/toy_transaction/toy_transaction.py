...
class ToyTransaction(Document):
    ...
    def validate_issue(self):
        article = frappe.get_doc("Toy Article", self.toy)
        transaction_type = frappe.db.get_value('Toy Transaction', {
                "library_member": self.library_member, "toy": self.toy, "docstatus": 1
            }, "transaction_type")
